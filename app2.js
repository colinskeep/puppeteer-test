...
try {
  (async () => {
    ...
    await page.type('.whsOnd.zHQkBf', 'bankers.schedule11@gmail.com');
    ...
    console.log('logged in: ', 'bankers.schedule11@gmail.com')
    ...
    for (let i = 0; i < hrefs.length; i++) {
      if (hrefs[i].indexOf('pageid') > - 1) {
        ...
        if (i == hrefs.length - 1) {
          console.log('found ',arr.length, 'brand accounts for', 'bankers.schedule11@gmail.com');
